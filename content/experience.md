...
<p class="phase-subtitle">Focus: OSS/BSS Systems, Telecom, Enterprise Integration</p>
<ul>
<li>Developed and tested software projects for major telecom operators across multiple countries</li>
<li>Worked on critical OSS and BSS support systems</li>
<li>Built large-scale enterprise Java applications using J2EE/JEE</li>
<li>Worked with Oracle databases and enterprise application servers</li>
</ul>
<div class="tech-stack-line">
<strong>Key Technologies:</strong> Java EE, Spring, Hibernate, Oracle DB, SOAP, Maven
</div>
</div>
</div>
...
<p class="phase-subtitle">Focus: Learning Management Systems (LMS), Retail Management, Full Stack</p>
<ul>
<li>Developed large-scale Learning Management Systems for corporate academies</li>
<li>Led documentation and refactoring efforts to enhance system efficiency</li>
<li>Contributed to the core development team for a major Retail Management System</li>
<li>Built multi-tier architectures and integrated frontend (AngularJS) with backend REST/SOAP APIs</li>
</ul>
<div class="tech-stack-line">
<strong>Key Technologies:</strong> Spring Framework, Hibernate JPA, Apache CXF, AngularJS, OSGI
</div>
</div>
</div>
...
<li>Modernised legacy infrastructure (Java 6 to 8+, Infinispan to Redis 6, Tomcat 10)</li>
...
<div class="timeline-content">
<h3>Phase 4 — Independent Cloud-Native Architect</h3>
...
<li>Integrated Keycloak with Grafana using auth proxy to enable secure observability access</li>
